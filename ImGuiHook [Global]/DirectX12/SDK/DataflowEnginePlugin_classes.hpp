...
{
public:
	class UDataflowComponent*                     DataflowComponent;                                 // 0x0470(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADataflowActor) == 0x000478, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x000470, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
...
static_assert(sizeof(UDataflowComponent) == 0x000960, "Wrong size on UDataflowComponent");
