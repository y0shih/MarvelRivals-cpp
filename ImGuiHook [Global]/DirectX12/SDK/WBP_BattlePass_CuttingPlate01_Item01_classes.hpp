...
public:
	...
	class UWidgetAnimation*                       Anim_HoverToPressl;                                // 0x0C10(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(UWBP_BattlePass_CuttingPlate01_Item01_C) == 0x000010, "Wrong alignment on UWBP_BattlePass_CuttingPlate01_Item01_C");
static_assert(sizeof(UWBP_BattlePass_CuttingPlate01_Item01_C) == 0x000D30, "Wrong size on UWBP_BattlePass_CuttingPlate01_Item01_C");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_Unlock_Normal) == 0x000BD8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_Unlock_Normal' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_Free_Normal) == 0x000BE0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_Free_Normal' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_Unlock) == 0x000BE8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_Unlock' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_SelectToNormal) == 0x000BF0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_SelectToNormal' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_Flow) == 0x000BF8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_Flow' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_Refresh) == 0x000C00, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_Refresh' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_PresslToHover) == 0x000C08, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_PresslToHover' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_HoverToPressl) == 0x000C10, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_HoverToPressl' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_HoverToSelect) == 0x000C18, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_HoverToSelect' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Anim_HoverToNor) == 0x000C20, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Anim_HoverToNor' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Btn_Item) == 0x000C28, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Btn_Item' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Btn_Select) == 0x000C30, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Btn_Select' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, CanvasPanel_Vx_Hover) == 0x000C38, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::CanvasPanel_Vx_Hover' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Img_Exchange) == 0x000C40, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Img_Exchange' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Img_Item_Bg) == 0x000C48, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Img_Item_Bg' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Img_Item_Select) == 0x000C50, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Img_Item_Select' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, MarvelImage_90) == 0x000C58, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::MarvelImage_90' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, MarvelRichTextBlock_92) == 0x000C60, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::MarvelRichTextBlock_92' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Overlay_Label) == 0x000C68, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Overlay_Label' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Overlay_Tips) == 0x000C70, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Overlay_Tips' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Text_Label) == 0x000C78, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Text_Label' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow) == 0x000C80, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow_1) == 0x000C88, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow_1' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow01) == 0x000C90, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow01' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow01_1) == 0x000C98, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow01_1' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow02) == 0x000CA0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow02' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow02_1) == 0x000CA8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow02_1' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow03) == 0x000CB0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow03' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow03_1) == 0x000CB8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow03_1' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Flow_Add) == 0x000CC0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Flow_Add' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow04) == 0x000CC8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow04' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow06) == 0x000CD0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow06' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow07) == 0x000CD8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow07' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow08) == 0x000CE0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow08' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow09) == 0x000CE8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow09' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow10) == 0x000CF0, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow10' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow11) == 0x000CF8, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow11' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, Vx_lmg_Hover_Flow12) == 0x000D00, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::Vx_lmg_Hover_Flow12' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, WBP_BattlePass_GroupNumber) == 0x000D08, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::WBP_BattlePass_GroupNumber' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, WBP_BattlePass_ItemPrice) == 0x000D10, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::WBP_BattlePass_ItemPrice' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, WBP_Common_ImageMaskCut) == 0x000D18, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::WBP_Common_ImageMaskCut' has a wrong offset!");
static_assert(offsetof(UWBP_BattlePass_CuttingPlate01_Item01_C, WBP_Mask) == 0x000D20, "Member 'UWBP_BattlePass_CuttingPlate01_Item01_C::WBP_Mask' has a wrong offset!");
