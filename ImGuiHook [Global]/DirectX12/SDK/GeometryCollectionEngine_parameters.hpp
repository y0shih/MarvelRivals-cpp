...
public:
	...
	struct FHitResult                             OutHit;                                            // 0x0030(0x0160)(Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GeometryCollectionActor_RaycastSingle) == 0x000198, "Wrong size on GeometryCollectionActor_RaycastSingle");
...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x000190, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
