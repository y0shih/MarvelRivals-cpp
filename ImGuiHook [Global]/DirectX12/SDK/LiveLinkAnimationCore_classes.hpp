...
{
public:
	class ULiveLinkRetargetAsset*                 CurrentRetargetAsset;                              // 0x0418(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULiveLinkInstance) == 0x000420, "Wrong size on ULiveLinkInstance");
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x000418, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
