...
// 0x07E0 (0x09B0 - 0x01D0)
class alignas(0x10) UChaosVehicleMovementComponent : public UPawnMovementComponent
{
public:
	uint8                                         bReverseAsBrake : 1;                               // 0x01D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bThrottleAsBrake : 1;                              // 0x01D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D1[0x3];                                      // 0x01D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Mass;                                              // 0x01D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableCenterOfMassOverride;                       // 0x01D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D9[0x7];                                      // 0x01D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CenterOfMassOverride;                              // 0x01E0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChassisWidth;                                      // 0x01F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChassisHeight;                                     // 0x01FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DragCoefficient;                                   // 0x0200(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DownforceCoefficient;                              // 0x0204(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DragArea;                                          // 0x0208(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DebugDragMagnitude;                                // 0x020C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InertiaTensorScale;                                // 0x0210(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SleepThreshold;                                    // 0x0228(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SleepSlopeLimit;                                   // 0x022C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVehicleAerofoilConfig>         Aerofoils;                                         // 0x0230(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVehicleThrustConfig>           Thrusters;                                         // 0x0240(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FVehicleTorqueControlConfig            TorqueControl;                                     // 0x0250(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FVehicleTargetRotationControlConfig    TargetRotationControl;                             // 0x0290(0x0058)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FVehicleStabilizeControlConfig         StabilizeControl;                                  // 0x02E8(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_300[0x4];                                      // 0x0300(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bRawHandbrakeInput : 1;                            // 0x0304(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearUpInput : 1;                               // 0x0304(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearDownInput : 1;                             // 0x0304(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         BitPad_304_3 : 5;                                  // 0x0304(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_305[0x3];                                      // 0x0305(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWasAvoidanceUpdated : 1;                          // 0x0308(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         BitPad_308_1 : 7;                                  // 0x0308(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_309[0x3];                                      // 0x0309(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bParkEnabled : 1;                                  // 0x030C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_30D[0x3];                                      // 0x030D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UNetworkPhysicsComponent*               NetworkPhysicsComponent;                           // 0x0310(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FVehicleInputRateConfig                ThrottleInputRate;                                 // 0x03C0(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                BrakeInputRate;                                    // 0x0458(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                SteeringInputRate;                                 // 0x04F0(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                HandbrakeInputRate;                                // 0x0588(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                PitchInputRate;                                    // 0x0620(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                RollInputRate;                                     // 0x06B8(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FVehicleInputRateConfig                YawInputRate;                                      // 0x0750(0x0098)(Edit, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UChaosVehicleMovementComponent, Mass) == 0x0001D4, "Member 'UChaosVehicleMovementComponent::Mass' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, bEnableCenterOfMassOverride) == 0x0001D8, "Member 'UChaosVehicleMovementComponent::bEnableCenterOfMassOverride' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, CenterOfMassOverride) == 0x0001E0, "Member 'UChaosVehicleMovementComponent::CenterOfMassOverride' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ChassisWidth) == 0x0001F8, "Member 'UChaosVehicleMovementComponent::ChassisWidth' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, ChassisHeight) == 0x0001FC, "Member 'UChaosVehicleMovementComponent::ChassisHeight' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DragCoefficient) == 0x000200, "Member 'UChaosVehicleMovementComponent::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DownforceCoefficient) == 0x000204, "Member 'UChaosVehicleMovementComponent::DownforceCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DragArea) == 0x000208, "Member 'UChaosVehicleMovementComponent::DragArea' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, DebugDragMagnitude) == 0x00020C, "Member 'UChaosVehicleMovementComponent::DebugDragMagnitude' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, InertiaTensorScale) == 0x000210, "Member 'UChaosVehicleMovementComponent::InertiaTensorScale' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SleepThreshold) == 0x000228, "Member 'UChaosVehicleMovementComponent::SleepThreshold' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, SleepSlopeLimit) == 0x00022C, "Member 'UChaosVehicleMovementComponent::SleepSlopeLimit' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, Aerofoils) == 0x000230, "Member 'UChaosVehicleMovementComponent::Aerofoils' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, Thrusters) == 0x000240, "Member 'UChaosVehicleMovementComponent::Thrusters' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, TorqueControl) == 0x000250, "Member 'UChaosVehicleMovementComponent::TorqueControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, TargetRotationControl) == 0x000290, "Member 'UChaosVehicleMovementComponent::TargetRotationControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, StabilizeControl) == 0x0002E8, "Member 'UChaosVehicleMovementComponent::StabilizeControl' has a wrong offset!");
static_assert(offsetof(UChaosVehicleMovementComponent, NetworkPhysicsComponent) == 0x000310, "Member 'UChaosVehicleMovementComponent::NetworkPhysicsComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_418[0x808];                                    // 0x0418(0x0808)(Fixing Size After Last Property [ Dumper-7 ])
	class UChaosWheeledVehicleMovementComponent*  WheeledVehicleComponent;                           // 0x0C20(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVehicleAnimationInstance) == 0x000C30, "Wrong size on UVehicleAnimationInstance");
static_assert(offsetof(UVehicleAnimationInstance, WheeledVehicleComponent) == 0x000C20, "Member 'UVehicleAnimationInstance::WheeledVehicleComponent' has a wrong offset!");
...
{
public:
	class USkeletalMeshComponent*                 Mesh;                                              // 0x0510(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UChaosVehicleMovementComponent*         VehicleMovementComponent;                          // 0x0518(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AWheeledVehiclePawn) == 0x000520, "Wrong size on AWheeledVehiclePawn");
static_assert(offsetof(AWheeledVehiclePawn, Mesh) == 0x000510, "Member 'AWheeledVehiclePawn::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehiclePawn, VehicleMovementComponent) == 0x000518, "Member 'AWheeledVehiclePawn::VehicleMovementComponent' has a wrong offset!");
