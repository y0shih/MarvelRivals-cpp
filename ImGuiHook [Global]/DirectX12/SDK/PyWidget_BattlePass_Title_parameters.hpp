...
static_assert(offsetof(PyWidget_BattlePass_Title_MarvelSetVisible, Visible) == 0x000000, "Member 'PyWidget_BattlePass_Title_MarvelSetVisible::Visible' has a wrong offset!");
