...
static_assert(sizeof(WidgetInteractionComponent_SetCustomHitResult) == 0x000160, "Wrong size on WidgetInteractionComponent_SetCustomHitResult");
...
{
public:
	struct FHitResult                             ReturnValue;                                       // 0x0000(0x0160)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(WidgetInteractionComponent_GetLastHitResult) == 0x000160, "Wrong size on WidgetInteractionComponent_GetLastHitResult");
