...
public:
	...
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x0160)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(InteractiveFoliageActor_CapsuleTouched) == 0x000180, "Wrong size on InteractiveFoliageActor_CapsuleTouched");
