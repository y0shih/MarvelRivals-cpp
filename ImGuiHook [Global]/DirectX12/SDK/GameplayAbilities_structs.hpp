...
static_assert(sizeof(FAbilityActivationExtraInfo) == 0x000020, "Wrong size on FAbilityActivationExtraInfo");
...
public:
	...
	struct FPredictionKey                         PredictionKeyWhenActivated;                        // 0x01F0(0x00A0)(HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FGameplayAbilityActivationInfo) == 0x000008, "Wrong alignment on FGameplayAbilityActivationInfo");
static_assert(sizeof(FGameplayAbilityActivationInfo) == 0x000290, "Wrong size on FGameplayAbilityActivationInfo");
...
static_assert(offsetof(FGameplayAbilityActivationInfo, PredictionKeyWhenActivated) == 0x0001F0, "Member 'FGameplayAbilityActivationInfo::PredictionKeyWhenActivated' has a wrong offset!");

// ScriptStruct GameplayAbilities.GameplayAbilitySpec
// 0x0460 (0x0478 - 0x0018)
...
public:
	...
	struct FGameplayAbilityActivationInfo         ActivationInfo;                                    // 0x00F0(0x0290)(RepSkip, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DynamicAbilityTags;                                // 0x0380(0x0068)(NativeAccessSpecifierPublic)
	TArray<class UGameplayAbility*>               NonReplicatedInstances;                            // 0x03E8(0x0010)(ZeroConstructor, RepSkip, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UGameplayAbility*>               ReplicatedInstances;                               // 0x03F8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          ActivateOnceImmediately;                           // 0x0408(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bConfirmInit;                                      // 0x0409(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_40A[0x2];                                      // 0x040A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           AbilityStatus;                                     // 0x040C(0x000C)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWasCancelled;                                     // 0x0418(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_419[0x3];                                      // 0x0419(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FActiveGameplayEffectHandle            GameplayEffectHandle;                              // 0x041C(0x0008)(RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_424[0x54];                                     // 0x0424(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayAbilitySpec) == 0x000008, "Wrong alignment on FGameplayAbilitySpec");
static_assert(sizeof(FGameplayAbilitySpec) == 0x000478, "Wrong size on FGameplayAbilitySpec");
...
static_assert(offsetof(FGameplayAbilitySpec, DynamicAbilityTags) == 0x000380, "Member 'FGameplayAbilitySpec::DynamicAbilityTags' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, NonReplicatedInstances) == 0x0003E8, "Member 'FGameplayAbilitySpec::NonReplicatedInstances' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ReplicatedInstances) == 0x0003F8, "Member 'FGameplayAbilitySpec::ReplicatedInstances' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, ActivateOnceImmediately) == 0x000408, "Member 'FGameplayAbilitySpec::ActivateOnceImmediately' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, bConfirmInit) == 0x000409, "Member 'FGameplayAbilitySpec::bConfirmInit' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, AbilityStatus) == 0x00040C, "Member 'FGameplayAbilitySpec::AbilityStatus' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, bWasCancelled) == 0x000418, "Member 'FGameplayAbilitySpec::bWasCancelled' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpec, GameplayEffectHandle) == 0x00041C, "Member 'FGameplayAbilitySpec::GameplayEffectHandle' has a wrong offset!");
...
{
public:
	struct FHitResult                             HitResult;                                         // 0x0008(0x0160)(IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bHitReplaced;                                      // 0x0168(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x000170, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000168, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
