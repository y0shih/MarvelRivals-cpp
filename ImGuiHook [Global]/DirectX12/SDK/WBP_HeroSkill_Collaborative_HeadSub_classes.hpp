...
static_assert(alignof(UWBP_HeroSkill_Collaborative_HeadSub_C) == 0x000008, "Wrong alignment on UWBP_HeroSkill_Collaborative_HeadSub_C");
static_assert(sizeof(UWBP_HeroSkill_Collaborative_HeadSub_C) == 0x0003C8, "Wrong size on UWBP_HeroSkill_Collaborative_HeadSub_C");
static_assert(offsetof(UWBP_HeroSkill_Collaborative_HeadSub_C, Btn_Head) == 0x0003B8, "Member 'UWBP_HeroSkill_Collaborative_HeadSub_C::Btn_Head' has a wrong offset!");
static_assert(offsetof(UWBP_HeroSkill_Collaborative_HeadSub_C, WBP_HeroHead) == 0x0003C0, "Member 'UWBP_HeroSkill_Collaborative_HeadSub_C::WBP_HeroHead' has a wrong offset!");
